...
function ButtonModificar({ todo }) {
  ...
  return (
    <div className="updateForm flex flex-wrap">
      <button className="btn btn-circle flex" onClick={modificarTodo}>
        <svg
      ...
      {updateEditor && <UpdateForm todo={todo} />}
    </div>
  );
}
